...
|---------------------------------------------------------|----------------------------------------------------------------------------|----------------------------------------------|-------------------------------------|-------------------------------------------------|
| Sea Ice Extent Images (satellite images)                | 332 × 316 pixels (648 MB) (The images were cropped to a fixed Antarctic bounding box, removing colorbars and annotations, resulting in a final size of 332 × 316 pixels.)                                                 | Detection using CMAD                         | Image_processing.ipynb, Image_processing_for_py_gpu.ipynb        | [NOAA Sea Ice Extent Images](https://noaadata.apps.nsidc.org/NOAA/G02135/south/daily/images/)  |
